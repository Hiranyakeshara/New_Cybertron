...
<div class="modal fade" id="modalForExam" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
   <form class="refreshFrm" id="addExamFrm" method="post">
     <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Add Policy Exam</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
        ...
        <div class="col-md-12">
          ...
          <div class="form-group">
            ...
            <select class="form-control" name="year_level" id="year_level">
              ...
              <option value="first year">L - 1</option>
              <option value="second year">L - 2</option>
              <option value="third year">L - 3</option>
              <option value="fourth year">L - 4</option>
            </select>
          </div>
          <div class="form-group">
            <label>Email</label>
