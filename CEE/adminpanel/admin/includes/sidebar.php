                    ...
                    <div class="app-header__menu">
                        ...
                        <div class="app-sidebar__inner">
                            <ul class="vertical-nav-menu">
                                ...
                                <li class="app-sidebar__heading">MANAGE Policy EXAM</li>
                                <li>
                                    <a href="#">
                                         <i class="metismenu-icon pe-7s-display2"></i>
                                         Policy Exam
                                ...
                                <li class="app-sidebar__heading">POLICIES</li>
                                <li>
                                    <a href="home.php?page=manage-policies">
                                        <i class="metismenu-icon pe-7s-chat">
                                        </i>All Policies
                                    </a>
                                </li>
                                ...
                                <li>
                                    <a href="home.php?page=create-policy">
                                    <i class="metismenu-icon fas fa-plus"></i>
                                        </i>Create Policy Material
                                    </a>
                                </li>
