...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 10, 2025 at 08:14 AM
...
(69, 'IT', '2024-10-11 12:06:30'),
(72, 'FINANCE', '2024-10-11 12:06:52'),
(73, 'HR management policy mobile security ', '2025-06-10 03:44:06');
...
(5, 'Jane Rivera', '72', 'female', '2019-11-14', 'second year', 'jane@gmail.com', 'jane', 'active'),
(6, 'Glenn Duerme', '72', 'female', '2019-12-24', 'third year', 'glenn@gmail.com', 'glenn', 'active'),
(7, 'Maria Duerme', '72', 'female', '2018-11-25', 'second year', 'maria@gmail.com', 'maria', 'active'),
(8, 'Dave Limasac', '69', 'female', '2019-12-21', 'second year', 'dave@gmail.com', 'dave', 'active'),
(9, 'saman', '69', 'male', '2024-10-12', 'first year', 'saman@gmail.com', 'saman@12345', 'active'),
(10, 'employee_IT', '69', 'male', '2024-10-04', 'first year', 'employee@gmail.com', 'employee12345', 'active'),
(11, 'kasun kalhara', '69', 'male', '2024-10-03', 'first year', 'kasun@gmail.com', '$2y$10$n2qKD2nkkR.XUeEntl3UJOfoesa1zfxGjIQWqOnwkA1MYOlV7IwYK', 'active'),
(12, 'badboy', '69', 'male', '2024-10-15', 'first year', 'badboy@gmail.com', '$2y$10$NxiZyBziY2wWXotzky4h.Ozr0SAPKAYTg2DTnzFNKOK5AotNuAhxm', 'active'),
(13, 'uwasara indumini', '73', 'female', '2000-10-08', 'first year', 'uwasara45@gmail.com', '$2y$10$1e6jSMfPtO8C5.3zbXHz9OmPKz45ATWcErKqQTQtVIoDGJ1U.3HYK', 'active');
...
(321, 9, 26, 32, 'Choice A', 'new', '2024-10-11 12:02:37'),
(322, 9, 26, 31, 'Choice A', 'new', '2024-10-11 12:02:37'),
(323, 9, 27, 33, 'choice A', 'new', '2024-10-11 12:20:16'),
(324, 11, 27, 33, 'choice A', 'new', '2025-05-28 21:09:58');
...
(31, 26, 'sample Question', 'Choice A', 'Choice B', 'Choice C', 'Choice D', 'Choice D', 'active'),
(32, 26, 'Sample_Question 02', 'Choice A', 'Choice B', 'Choice C', 'Choice D', 'Choice D', 'active'),
(33, 27, 'sample question 01', 'choice A', 'choice B', 'Choice C', 'Choice D', 'choice B', 'active');
...
(24, 67, 'Policy Management Training', '10', 10, 'Sample decription', '2024-10-11 11:55:16'),
(27, 73, 'user policy exam', '10', 4, 'sample policy description for write this policy exam', '2025-06-10 04:50:17');
...
(10, 9, 'Anonymous', 'sample feedbac\r\n', 'October 11, 2024'),
(11, 9, '', '', 'October 11, 2024');
...
INSERT INTO `policies` (`id`, `policy_name`, `description`, `learn`, `date_created`) VALUES
(1, 'sample_policy name 05', 'Security', 'A User Security Awareness Policy is designed to educate and guide system users on best practices for maintaining a secure environment. It outlines the necessary actions to protect sensitive data, such as using strong passwords, recognizing phishing attempts, avoiding the use of untrusted software, and adhering to secure login procedures. The policy aims to ensure that all users are aware of potential threats, understand their role in safeguarding the system, and follow established protocols to p', '2024-10-11 21:19:07'),
(6, 'User Privilege Access', 'Access Control', 'A User Access Control Policy defines the rules and procedures for granting, managing, and restricting access to a system\'s resources based on user roles and responsibilities. It ensures that only authorized users can access specific data, applications, and services according to their job functions. The policy includes guidelines for role-based access control (RBAC), user authentication, permissions management, and regular access reviews to prevent unauthorized access. Its goal is to protect sens', '2024-10-11 21:22:08'),
(7, 'User Management', 'Access Control', 'A User Access Control Policy defines the rules and procedures for granting, managing, and restricting access to a system\'s resources based on user roles and responsibilities. It ensures that only authorized users can access specific data, applications, and services according to their job functions. The policy includes guidelines for role-based access control (RBAC), user authentication, permissions management, and regular access reviews to prevent unauthorized access. Its goal is to protect sens', '2024-10-11 21:22:47'),
(8, 'User Management', 'Access Control', 'A User Access Control Policy defines the rules and procedures for granting, managing, and restricting access to a system\'s resources based on user roles and responsibilities. It ensures that only authorized users can access specific data, applications, and services according to their job functions. The policy includes guidelines for role-based access control (RBAC), user authentication, permissions management, and regular access reviews to prevent unauthorized access. Its goal is to protect sens', '2024-10-12 00:06:12');
